...
public class Inventario : MonoBehaviour
{
    ...
    private void CargarInventarioVacio()    /*REPASAR*/
    {
    ...
    private void CargarInventarioGuardado() /*REPASAR*/
    {
    ...
    private InformacionSlot BuscarItemEnInventario(int idItem)  /*REPASAR*/
    {
    ...
    private InformacionSlot buscarSlotAdecuado(int idItem)  /*REPASAR*/
    {
